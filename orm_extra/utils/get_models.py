...
def is_excluded_model(model, exclude_modules=DEFAULT_EXCLUDE_MODELS_FROM_MODULES):
...
def get_models(exclude_modules=DEFAULT_EXCLUDE_MODELS_FROM_MODULES):
    ...
    for model in BaseModel.__subclasses__():
        ...
        if exclude_modules and is_excluded_model(model=model, exclude_modules=exclude_modules):
            continue
